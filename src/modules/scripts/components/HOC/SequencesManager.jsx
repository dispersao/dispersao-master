...
import { getLoading as getScriptSequencesLoading } from '../../../scriptsequences/selectors'
import {
  getCurrentScript,
...
const WithSequenceManager = (WrappedComponent) => {
  ...
  SequenceManager.propTypes = {
    ...
    creatingScriptSequence:PropTypes.bool,
  ...
  const mapStateToProps = (state) => ({
    ...
    creatingScriptSequence: getScriptSequencesLoading(state),
    closingCreditsScriptsequence:
      getCurrentScriptCreditsScriptsequenceByPosition(state, {
